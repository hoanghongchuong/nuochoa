      ...
      <div class="vk-breadcrumb">
          <nav class="container">
              <ul class="vk-list vk-list--inline vk-list__breadcrumb">
                  ...
                  <li class="vk-list__item"> <a href="#">Tìm kiếm từ khóa: {{$search}}</a></li>
              </ul>
          </nav>
      </div>
      <!--./vk-breadcrumb-->
                      ...
                      <div class="vk-shop__left">
                          <div class="vk-shop__left-inner">
                              <div class="vk-shop__heading-box">
                                  <h1 class="vk-shop__heading text-uppercase">Kết quả tìm kiếm từ khóa: {{$search}}</h1>
                                                      ...
                                                      <div class="row">
                                                              ...
                                                              <div class="vk-shop-detail__thumbnail-wrapper">
                                                                  <div class="vk-shop-detail__thumbnail">
                                                                      <div class="vk-slider__for" data-slider="slider-for">
                                                                        <?php $albumImg = DB::table('images')->select()->where('product_id',$item->id)->orderby('id','asc')->get(); ?>
                                                          ...
                                                          <div class="vk-shop-detail__right col-lg-6">
                                                              ...
                                                              <div class="vk-shop-detail__brief">
                                                                  <h1 class="vk-shop-detail__title">{{$item->name}} </h1>

                                                                  <div class="vk-shop-detail__box">

                                                                      <p class="vk-shop-detail__price vk-text--red-1">{{number_format($item->price)}} ₫ </p>

                                                                      <div class="vk-shop-detail__brief-short">
                                                                          <?php $thuonghieu = DB::table('thuonghieu')->select('name')->where('id',$item->thuonghieu_id)->first(); ?>
                                                                      ...
                                                                      <div class="vk-button">
                                                                          ...
                                                                          <a href="{{url('san-pham/'.$item->alias.'.html')}}" title="" class="vk-btn vk-btn--now text-uppercase _inverse">Chi tiết</a>
                                                                      </div>
