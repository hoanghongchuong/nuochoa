                        ...
                        <div class="vk-shop__left">
                            <div class="vk-shop__left-inner">
                                <div class="vk-shop__heading-box">
                                    <h1 class="vk-shop__heading text-uppercase">Nước hoa</h1>
                            ...
                            <!-- <nav class="vk-pagination">
                                <ul class="vk-list vk-list--inline vk-pagination__list">
                                    <li class="vk-list__item"><a href="#" title=""><i class="_icon fa fa-angle-left"></i></a></li>
                                    <li class="vk-list__item _active"><a href="#" title="">1</a></li>
                                    <li class="vk-list__item"><a href="#" title="">2</a></li>
                                    <li class="vk-list__item"><a href="#" title="">3</a></li>
                                    <li class="vk-list__item"><a href="#" title=""><i class="_icon fa fa-angle-right"></i></a></li>
                                </ul>
                            </nav> -->
                            ...
                            <div class="vk-sidebar">
                                ...
                                <div class="vk-sidebar__box">
                                    ...
                                    <ul class="vk-list vk-list--mod-1 text-capitalize">
                                        ...
                                        <li class="vk-list__item"><a href="#" title="">{{$thuonghieu->name}}</a></li>
                                        @endforeach
                                    </ul>
